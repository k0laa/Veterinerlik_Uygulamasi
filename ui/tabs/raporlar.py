...
def setup_raporlar_tab(window, tab):
        ...
        # Rapor tablosu
        table = QTableWidget()
        table.setColumnCount(10)  # Sütun sayısını 10 olarak güncelle
        ...
        table.setColumnWidth(6, 120)  # Durum
        table.setColumnWidth(7, 80)   # İlerleme
        table.setColumnWidth(8, 200)  # Açıklama
        table.setColumnWidth(9, 200)  # İlaçlar
